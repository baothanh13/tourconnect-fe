        ...
        {(selectedCity || selectedCountry) && (
          <div className="active-filters">
            ...
            <div className="filter-tags">
              {selectedCity && (
                <span className="filter-tag city-filter">
                  📍 {selectedCity}
                  <button
              ...
              {selectedCountry && (
                <span className="filter-tag country-filter">
                  🌍 {selectedCountry}
                  <button
            ...
            <p className="results-count">
              Found {filteredAndSortedGuides.length} guide
              {filteredAndSortedGuides.length !== 1 ? "s" : ""}
