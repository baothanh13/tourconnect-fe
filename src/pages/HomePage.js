  ...
  const featuredDestinations = [
    {
      name: "Hanoi",
      image:
        "https://images.unsplash.com/photo-1509923936403-148b60b94328?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description:
        "Explore the historic capital with ancient temples and vibrant street life",
    },
    {
      ...
      description:
        "Discover the dynamic metropolis blending tradition and modernity",
    },
    {
      name: "Hoi An",
      image:
      ...
      description:
        "Wander through the enchanting ancient town with lantern-lit streets",
    },
    {
      name: "Hue",
      image:
    ...
    },
    {
      name: "Da Nang",
      image:
        "https://images.unsplash.com/photo-1559047332-bd2fdc4c543f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
      description: "Enjoy beautiful beaches and marble mountain adventures",
    },
    {
      name: "Nha Trang",
      image:
        "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p className="hero-subtitle">
              Connect with authentic, top-rated guides for an unforgettable
              adventure
            </p>
          </div>
          ...
          <div className="steps-grid">
            <div className="step">
              ...
              <p className="step-description">
                Browse our curated selection of local guides and find the
            ...
            <div className="step">
              ...
              <p className="step-description">
                Choose your preferred date, time, and customize your experience
                with your selected guide
              </p>
            </div>
            ...
            <div className="step">
              ...
              <p className="step-description">
                Meet your guide and embark on an authentic, personalized journey
                through Vietnam
              </p>
            </div>
          </div>
