...
INSERT INTO `bookings` VALUES ('44af3e43-53f9-443e-b1f0-54ef0d5bc4b7','71ab5530-a5d3-46b9-9f03-374dc96e0221','a4bcb60a-62da-4da8-a465-174075eb3bfe','2025-08-09','08:00:00',5,20,200.00,'confirmed','pending','I hope you can singing while guide us','2025-08-09 04:58:56'),('B25082102708','G25082101805','U25082003795','2025-08-21','08:00:00',3,2,75.00,'confirmed','pending','Speak Japanese','2025-08-21 02:50:48'),('B25082901556','G25082101805','U25082003795','2025-08-29','09:00:00',4,3,50.00,'confirmed','pending','None','2025-08-29 01:54:11'),('B25082904931','G25082101805','U25082003795','2025-08-29','11:00:00',4,6,100.00,'pending','pending','None','2025-08-29 04:26:13');
/*!40000 ALTER TABLE `bookings` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `favourite_guides`
--

DROP TABLE IF EXISTS `favourite_guides`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `favourite_guides` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tourist_id` varchar(50) NOT NULL,
  `guide_id` varchar(50) NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_favorite` (`tourist_id`,`guide_id`),
  KEY `fk_favorite_guides_guide` (`guide_id`),
  CONSTRAINT `fk_favorite_guides_guide` FOREIGN KEY (`guide_id`) REFERENCES `guides` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_favorite_guides_tourist` FOREIGN KEY (`tourist_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `favourite_guides`
--

LOCK TABLES `favourite_guides` WRITE;
/*!40000 ALTER TABLE `favourite_guides` DISABLE KEYS */;
INSERT INTO `favourite_guides` VALUES (1,'U25082003795','G25082101805','2025-08-30 01:45:34');
/*!40000 ALTER TABLE `favourite_guides` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `guides` VALUES ('G25082101805','U25082016650','Ho Chi Minh','[\"English\"]','[\"Cultural Tours\"]',20.00,5,'Experienced tour guide with deep knowledge of Hanoi history.','[\"Language Certificate B\"]',3.75,2,1,NULL,'verified',NULL);
...
INSERT INTO `reviews` VALUES ('R25082904623','B25082901556','U25082003795','G25082101805','Dinh Doc Lap Walking Tour',4.5,'Great guide, very friendly!','2025-08-29 04:50:06'),('R25082905311','B25082102708','U25082003795','G25082101805','Chua Mot Cot Walking Tour',3.0,'Di ngu','2025-08-29 05:03:45');
...
INSERT INTO `tours` VALUES ('T25082705698','G25082101805','Dong Hoi Walking Tour','Explore Nhat Le River, Bao Ninh beach, Quang Binh Quan',3,5,10.00,'https://api.sovaba.travel/uploads/sm_Toan_canh_thanh_pho_dong_hoi_nhin_tu_tren_cao_8d1107278a.jpg','Cultural Tours','2025-08-27 05:57:15','2025-08-31 09:10:17','2025-08-27','07:00:00'),('T25082713747','G25082101805','The Imperial City of Hue Walking Tour','In this tour, you will enjoy the beautiful scenes of the imperial',2,10,15.00,'https://st.ielts-fighter.com/src/ielts-fighter-image/2023/03/23/3c1a0be3-c26b-4d72-bbd1-6dae9a216784.jpg','historical','2025-08-27 13:21:44','2025-08-30 13:47:36','2025-08-30','09:00:00');
...
CREATE TABLE `wishlists` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_wishlist` (`tourist_id`,`tour_id`),
  KEY `fk_wishlists_tour` (`tour_id`),
  CONSTRAINT `fk_wishlists_tour` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_wishlists_tourist` FOREIGN KEY (`tourist_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `wishlists` VALUES (1,'U25082003795','T25082713747','2025-08-30 01:46:22');
...
-- Dump completed on 2025-09-01 22:10:02
